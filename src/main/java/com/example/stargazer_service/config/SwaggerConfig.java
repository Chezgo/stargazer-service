package com.example.stargazer_service.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI telescopeBrandDetailOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("Stargazer Service API")
                        .description("""
                    API для управления сущностями приложения сервиса Stargazer.
                    <br><br>
                ...
                .addServersItem(new Server()
                        .url("https://api.our-galaxy.space/stargazer-service")
